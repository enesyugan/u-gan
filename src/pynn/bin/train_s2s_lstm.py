...
parser.add_argument('--train-scps', help='path to train scp', nargs='+', required=True)
parser.add_argument('--train-targets', help='path to train target', nargs='+', required=True)
parser.add_argument('--valid-scps', help='path to validation scp', nargs='+', required=True)
parser.add_argument('--valid-targets', help='path to validation target', nargs='+', required=True)
